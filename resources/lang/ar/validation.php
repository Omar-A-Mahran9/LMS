...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'answers.*.id' => 'السؤال',
        'banner' => 'البانر',
        'body_ar' => 'الرسالة بالعربي',
        'body_en' => 'الرسالة بالإنجليزي',
        'bundle_id' => 'الباقة',
        'category_ids' => 'الصفوف',
        'category_ids.*' => 'الصف',
        'certificate_available' => 'إتاحة الشهادة',
        'chat_embed_url' => 'رابط الشات',
        ...
        'have_reading_passages' => 'قطع القراءة',
        'home_work_id' => 'الواجب',
        'is_active' => 'التفعيل',
        'is_enrollment_open' => 'فتح الاشتراك',
        'is_featured' => 'مميز',
        'is_preview' => 'المعاينة المجانية',
        'is_recorded' => 'مسجل',
        'last_watched_second' => 'آخر ثانية مشاهدة',
        'logo_image' => 'الشعار',
        'light_logo_image' => 'الشعار الفاتح',
        ...
        'quantity' => 'الكمية',
        'section_id' => 'القسم',
        'short_title_ar' => 'العنوان المختصر بالعربي',
        'short_title_en' => 'العنوان المختصر بالإنجليزي',
        'show_in_home' => 'الظهور في الرئيسية',
        'single_use' => 'استخدام لمرة واحدة',
        'slug' => 'الرابط المختصر',
