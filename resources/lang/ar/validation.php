...
'label_about_us_ar'        => 'نبذة عنا (بالعربية)',
    ...
    'label_service_ar'         => 'كورساتنا (بالعربية)',
    'label_service_en'         => 'كورساتنا (بالإنجليزية)',

    'about_us_banner'           => 'صورة قسم نبذة عنا',
    'contact_banner'            => 'صورة قسم التواصل',
    'service_banner'            => 'صورة قسم الكورسات',
    ...
    'description_service_en'   => 'وصف قسم الكورسات (بالإنجليزية)',
    'description_service_ar'   => 'وصف قسم الكورسات (بالعربية)',
