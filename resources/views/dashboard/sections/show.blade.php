                                ...
                                <div id="add_btn" data-bs-toggle="modal" data-bs-target="#crud_modal"
                                    ...
                                    @if (!$quizExists)
                                        <button type="button" class="btn btn-primary" id="quiz_btn"
                                            data-bs-toggle="tooltip" data-bs-original-title="{{ __('Add') }}"
...
@push('scripts')
    ...
    <script>
        ...
        function generateVideoTitles(count) {
            const next = count + 1;
            const titleEn = `Part ${englishNumbersMap[next] || next} (${next})`;
            const titleAr = `Part ${arabicNumbersMap[next] || next} (${next})`;
