...
@section('content')
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('sections list') }}</h3>
            </div>
            <!--end::Card title-->
            ...
            <div class="d-flex justify-content-center flex-wrap mb-5 mt-5">
                ...
                <div class="d-flex justify-content-end w-100" id="add_btn" data-bs-toggle="modal"
                    ...
                    <button type="button" class="btn btn-primary w-100" data-bs-toggle="tooltip"
                        ...
                        <!--end::Svg Icon-->{{ __('Add new section') }}
                    </button>
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
    ...
    <form id="crud_form" class="ajax-form w-75" action="{{ route('dashboard.sections.store') }}" method="post"
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add new section') }}</h5>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/sections.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#add_btn").click(function(e) {
                ...
                // Clear validation errors and invalid sections
                ...
                $("#crud_form").attr('action', "{{ route('dashboard.sections.store') }}");

                // Reset modal title
                $("#form_title").text("{{ __('Add new section') }}");
