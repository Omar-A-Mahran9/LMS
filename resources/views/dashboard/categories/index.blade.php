            ...
            <table id="kt_datatable" class="table align-middle text-center table-row-dashed fs-6 gy-5">
                <thead>
                    <tr class=" text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        @endif
                        <th>{{ __('Meta tag keywords') }}</th>
                        <th>{{ __('Meta tag key description') }}</th>
                        <th>{{ __('Created at') }}</th>
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add Main Category') }}</h5>
                        <!--begin::Close-->
                    ...
                    <div class="modal-body">
                        ...
                        @if (request('type') === 'sub')
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                ...
                                <select class="form-select form-select-solid" data-control="select2" name="parent_id"
                                    id="parent-category-sp" data-placeholder="{{ __('Choose the main category') }}"
                        ...
                        <div class="fv-row mb-0 fv-plugins-icon-container">
                            ...
                            <input type="text" name="meta_tag_key_words"
                                ...
                                placeholder="{{ __('Meta tag keywords') }}">
