...
!(function (t, e) {
            ...
            if (Object.prototype.hasOwnProperty.call(t, i)) {
                ...
                e.length && (e += "&"),
                    (s =
                        "[object Array]" === o
                            ? "[object Object]" ===
                              Object.prototype.toString.call(r[0])
                                ? JSON.stringify(r)
                                : r.join(",")
                            : "[object Object]" === o
                            ? JSON.stringify(r)
    ...
    var y = { request: p, get: m, post: h },
        ...
        S = function t(e, i) {
            ...
            if (
                ...
                e.points &&
                    ((s.type = "MultiPoint"),
                    (s.coordinates = e.points.slice(0))),
                e.paths &&
                    (1 === e.paths.length
                        ? ((s.type = "LineString"),
                          (s.coordinates = e.paths[0].slice(0)))
            ...
            if (
                ...
                for (var o = s.length - 1; o >= 0; o--)
                    r.catalogItems.features[
                        o
                    ].properties.catalogItemVisibility = s[o];
            return r;
        },
    });
    function et(t) {
    ...
    var at = it.extend({
        ...
        addFeatures: function (t, e, i) {
            for (
                var s = t.features ? t.features : [t], r = s.length - 1;
                r >= 0;
                r--
            )
                delete s[r].id;
        ...
        ht = e.TileLayer.extend({
            ...
            initialize: function (t, i) {
                ...
                e.Util.setOptions(this, r),
                    ...
                    this.options.proxy &&
                        (s.urlTemplate =
                            this.options.proxy + "?" + s.urlTemplate),
        ...
        createTile: function (t, i) {
            ...
            return (
                e.DomEvent.on(
                    s,
                    "load",
                    e.Util.bind(this._tileOnLoad, this, i, s)
                ),
                e.DomEvent.on(
                    s,
                    "error",
                    e.Util.bind(this._tileOnError, this, i, s)
                ),
                ...
                this._lodMap ||
                    this.metadata(function (i, s) {
                        if (!i && s.spatialReference) {
                            var r =
                                s.spatialReference.latestWkid ||
                                s.spatialReference.wkid;
                            if (
                                (!this.options.attribution &&
                                    t.attributionControl &&
                                    s.copyrightText &&
                                ...
                                this._lodMap = {};
                                for (
                                    var o = s.tileInfo.lods,
                                        n = ct.MercatorZoomLevels,
                                        a = 0;
                                    a < o.length;
                                    a++
                                ) {
        ...
        mt = dt.extend({
            ...
            _getPopupData: function (t) {
                ...
                this.options.mosaicRule &&
                    s.setMosaicRule(this.options.mosaicRule),
                    s.run(i),
    ...
    var yt = e.Layer.extend({
        ...
        _update: function (t) {
            ...
            if (i) {
                ...
                for (var h in this._cells) {
                    ...
                    (c.z === this._cellZoom &&
                        u.contains(new e.Point(c.x, c.y))) ||
                ...
                if (Math.abs(s - this._cellZoom) > 1) this._setView(t, s);
                    ...
                    for (var p = o.min.y; p <= o.max.y; p++)
                        for (var d = o.min.x; d <= o.max.x; d++) {
                            ...
                            if (
                                ((m.z = this._cellZoom), this._isValidCell(m))
                            ) {
        ...
        _cellCoordsToBounds: function (t) {
            ...
            return (
                this.options.noWrap || (s = this._map.wrapLatLngBounds(s)), s
            );
        },
    ...
    var _t = yt.extend({
            ...
            initialize: function (t) {
                ...
                this.options.timeField.start && this.options.timeField.end
                    ? ((this._startTimeIndex = new gt()),
                      (this._endTimeIndex = new gt()))
                    ...
                    for (e = t.length - 1; e >= 0; e--)
                        (i = t[e]),
                            s.push({
                                id: i.id,
                                value: new Date(
                                    i.properties[this.options.timeField.start]
                                ),
                            }),
                            r.push({
                                id: i.id,
                    ...
                    for (var s in this._layers)
                        -1 !==
                            this._currentSnapshot.indexOf(
                                this._layers[s].feature.id
                            ) &&
                            (("function" == typeof this._layers[s].getLatLng &&
                                i.contains(this._layers[s].getLatLng())) ||
                                ("function" ==
                                    typeof this._layers[s].getBounds &&
                                    i.intersects(
                                        this._layers[s].getBounds()
                                    ))) &&
...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : t(
              (((e =
                  "undefined" != typeof globalThis ? globalThis : e || self).L =
                  e.L || {}),
              (e.L.esri = e.L.esri || {}),
              (e.L.esri.Geocoding = {})),
              e.L,
    ...
    var d = t.Evented.extend({
                    ...
                    return t.Util.bind(function (t, r) {
                        ...
                        o._lastRender !== e &&
                            ...
                            r.length &&
                                ...
                                ((o._lastRender = e),
                                this._control._renderSuggestions(r)),
        ...
        _boundsFromResults: function (e) {
            if (e.length) {
                ...
                for (var a = t.latLngBounds(o), l = 0; l < i.length; l++)
                    a.extend(i[l]);
                return a;
            }
        },
                    ...
                    function (e) {
                        ...
                        for (
                            var i,
                                ...
                                r = this._suggestions.querySelectorAll(
    ...
    var v = s.FeatureLayerService.extend({
                    ...
                    if (e) s(e, []);
                        ...
                        for (
                            ...
                            o.push({
                                ...
                                unformattedText:
                                    n.properties[this.options.searchFields[0]],
                                magicKey: n.id,
                            });
                        }
        ...
        _buildQuery: function (e) {
            for (
                var t = [], s = this.options.searchFields.length - 1;
                s >= 0;
                s--
            ) {
    ...
    var m = s.MapService.extend({
                            ...
                            (a.layerId = u),
                                ...
                                h &&
                                    o.push({
                                        ...
                                        unformattedText:
                                            a.properties[a.displayFieldName],
            ...
            return o.run(function (e, t, s) {
                if (!e) {
                    ...
                    for (var o = 0; o < t.features.length; o++) {
                        var n = t.features[o];
                        if (
                            ((a = a || s.results[o].layerId), n && void 0 !== a)
                        ) {
        ...
        _layerMetadataCallback: function (e) {
            return t.Util.bind(function (t, s) {
                if (!t) {
                    (this._displayFields[e] = s.displayField),
                        (this._layerNames[e] = s.name);
