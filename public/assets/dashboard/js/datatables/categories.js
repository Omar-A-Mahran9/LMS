...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        ...
        if (categoryType === "sub")
            ...
            columns.splice(4, 0, { data: "parent.name" });
    ...
    // If your rows have a data attribute for type
    document.querySelectorAll('tr').forEach(row => {
        const type = row.dataset.type; // 'parent' or 'sub'
        deleteRowWithURL(`/dashboard/${dbTable}/`, type);
    });
