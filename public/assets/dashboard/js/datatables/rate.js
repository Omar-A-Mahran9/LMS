    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach((btn) => {
            btn.addEventListener("click", function (e) {
                ...
                // Set rate
                $("#rate_inp").val(data.rate).trigger("change");

                // Set status dropdown
                // Handle status switch (checkbox)
                if (data.status === "approve") {
                    $("#status_inp").prop("checked", true);
                } else {
                    $("#status_inp").prop("checked", false);
                }
                ...
                if (data.audio_full_path) {
                    $("#audio_source").attr("src", data.audio_full_path);
                    $("#audio_preview audio")[0].load(); // reload audio element
                    $("#audio_preview").show();
                } else {
                    $("#audio_preview").hide();
                }
                ...
                // Inject _method for PUT
                $("#crud_form input[name=_method]").remove(); // clean existing
                $("#crud_form").prepend(
